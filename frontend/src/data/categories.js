    ...
    subcategories: [
      {
        ...
        attributes: [
          ...
          { key: 'storage', label: 'Storage', type: 'select-dependent', dependsOn: 'model', required: true,
            ...
            // (e.g. Tecno/Infinix/Itel models — exact specs vary by
            // sub-variant and aren't populated yet; edit this file to
            // add real per-model specs as they're confirmed).
          ...
          { key: 'ram', label: 'RAM', type: 'select-dependent', dependsOn: 'model', required: false,
            ...
            fallbackOptions: ['3GB', '4GB', '6GB', '8GB', '12GB'] },
